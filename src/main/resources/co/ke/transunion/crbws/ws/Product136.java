...
/**
 * <p>Java class for product136 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="product136">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="accountList" type="{http://ws.crbws.transunion.ke.co/}account136" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="scoreOutput" type="{http://ws.crbws.transunion.ke.co/}scoreOutput136" minOccurs="0"/>
 *         &lt;element name="shareholdingList" type="{http://ws.crbws.transunion.ke.co/}shareholding" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="summary" type="{http://ws.crbws.transunion.ke.co/}summary136" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "product136", propOrder = {
    "accountList",
    "alsoKnownAsList",
    "bouncedChequeList",
    "collateralList",
...
public class Product136 {
    ...
    protected List<Account136> accountList;
    @XmlElement(nillable = true)
    ...
    protected ScoreOutput136 scoreOutput;
    @XmlElement(nillable = true)
    protected List<Shareholding> shareholdingList;
    protected Summary136 summary;
     ...
     * 
     */
    public List<Account136> getAccountList() {
        if (accountList == null) {
            accountList = new ArrayList<Account136>();
        }
     ...
     *     
     */
    public ScoreOutput136 getScoreOutput() {
        return scoreOutput;
    }
     ...
     *     
     */
    public void setScoreOutput(ScoreOutput136 value) {
     ...
     *     
     */
    public void setSummary(Summary136 value) {
        this.summary = value;
    }
