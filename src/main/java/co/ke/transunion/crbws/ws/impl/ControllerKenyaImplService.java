 ...
 * 
 */
@WebServiceClient(name = "ControllerKenyaImplService", targetNamespace = "http://impl.ws.crbws.transunion.ke.co/", wsdlLocation = "https://secure3.crbafrica.com/crbws/ke?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://secure3.crbafrica.com/crbws/ke?wsdl");
