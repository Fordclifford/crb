...
/**
 * <p>Java class for product163 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="product163">
 *   &lt;complexContent>
 ...
 *         &lt;element name="scoreList" type="{http://ws.crbws.transunion.ke.co/}averageScoreOutput" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="shareholderList" type="{http://ws.crbws.transunion.ke.co/}shareholder" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="summary" type="{http://ws.crbws.transunion.ke.co/}summary163" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "product163", propOrder = {
    "accountList",
    "alsoKnownAsList",
    "bouncedChequeList",
    "collateralList",
...
public class Product163 {
    ...
    @XmlElement(nillable = true)
    protected List<AverageScoreOutput> scoreList;
    @XmlElement(nillable = true)
    protected List<Shareholder> shareholderList;
    protected Summary163 summary;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AverageScoreOutput }
     * 
     * 
     */
    public List<AverageScoreOutput> getScoreList() {
        if (scoreList == null) {
            scoreList = new ArrayList<AverageScoreOutput>();
        }
     ...
     *     
     */
    public void setSummary(Summary163 value) {
        this.summary = value;
    }
