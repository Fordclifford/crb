...
public class Product110  implements java.io.Serializable {
    private co.ke.transunion.crbws.ws.Account110[] accountList;
    ...
    public Product110(
           co.ke.transunion.crbws.ws.Account110[] accountList,
     ...
     * @return accountList
     */
    public co.ke.transunion.crbws.ws.Account110[] getAccountList() {
        return accountList;
    }
     ...
     * @param accountList
     */
    public void setAccountList(co.ke.transunion.crbws.ws.Account110[] accountList) {
        this.accountList = accountList;
    }

    public co.ke.transunion.crbws.ws.Account110 getAccountList(int i) {
        return this.accountList[i];
    }

    public void setAccountList(int i, co.ke.transunion.crbws.ws.Account110 _value) {
