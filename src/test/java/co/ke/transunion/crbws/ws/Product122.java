...
public class Product122  implements java.io.Serializable {
    private co.ke.transunion.crbws.ws.Account122[] accountList;

    private co.ke.transunion.crbws.ws.Header122 header;
    ...
    public Product122(
           co.ke.transunion.crbws.ws.Account122[] accountList,
           co.ke.transunion.crbws.ws.Header122 header,
     ...
     * @return accountList
     */
    public co.ke.transunion.crbws.ws.Account122[] getAccountList() {
        return accountList;
    }
     ...
     * @param accountList
     */
    public void setAccountList(co.ke.transunion.crbws.ws.Account122[] accountList) {
        this.accountList = accountList;
    }

    public co.ke.transunion.crbws.ws.Account122 getAccountList(int i) {
        return this.accountList[i];
    }

    public void setAccountList(int i, co.ke.transunion.crbws.ws.Account122 _value) {
     ...
     * @return header
     */
    public co.ke.transunion.crbws.ws.Header122 getHeader() {
        return header;
    }
     ...
     * @param header
     */
    public void setHeader(co.ke.transunion.crbws.ws.Header122 header) {
        this.header = header;
    }
