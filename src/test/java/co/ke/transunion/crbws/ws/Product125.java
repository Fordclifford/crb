...
public class Product125  implements java.io.Serializable {
    private co.ke.transunion.crbws.ws.Account125[] accountList;

    private co.ke.transunion.crbws.ws.Header125 header;
    ...
    public Product125(
           co.ke.transunion.crbws.ws.Account125[] accountList,
           co.ke.transunion.crbws.ws.Header125 header,
     ...
     * @return accountList
     */
    public co.ke.transunion.crbws.ws.Account125[] getAccountList() {
        return accountList;
    }
     ...
     * @param accountList
     */
    public void setAccountList(co.ke.transunion.crbws.ws.Account125[] accountList) {
        this.accountList = accountList;
    }

    public co.ke.transunion.crbws.ws.Account125 getAccountList(int i) {
        return this.accountList[i];
    }

    public void setAccountList(int i, co.ke.transunion.crbws.ws.Account125 _value) {
     ...
     * @return header
     */
    public co.ke.transunion.crbws.ws.Header125 getHeader() {
        return header;
    }
     ...
     * @param header
     */
    public void setHeader(co.ke.transunion.crbws.ws.Header125 header) {
        this.header = header;
    }
